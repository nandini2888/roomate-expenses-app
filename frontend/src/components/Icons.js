...
// Colorful 3D Faceted Cube Brand Logo matching the benchmark reference
export const AppLogo = ({ className = 'w-8 h-8' }) => (
  <svg className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Top facet */}
    <path d="M20 3L35 11.5L20 20L5 11.5L20 3Z" fill="url(#logo-top)" />
    {/* Right facet */}
    <path d="M35 11.5V28.5L20 37V20L35 11.5Z" fill="url(#logo-right)" />
    {/* Left facet */}
    <path d="M5 11.5L20 20V37L5 28.5V11.5Z" fill="url(#logo-left)" />
    {/* Inset highlight cube */}
    <path d="M20 12L27 16L20 20L13 16L20 12Z" fill="#FFFFFF" fillOpacity="0.4" />
    <defs>
      <linearGradient id="logo-top" x1="5" y1="3" x2="35" y2="20" gradientUnits="userSpaceOnUse">
        <stop stopColor="#6366F1" />
        <stop offset="1" stopColor="#8B5CF6" />
      </linearGradient>
      <linearGradient id="logo-right" x1="20" y1="20" x2="35" y2="37" gradientUnits="userSpaceOnUse">
        <stop stopColor="#3B82F6" />
        <stop offset="1" stopColor="#0EA5E9" />
      </linearGradient>
      <linearGradient id="logo-left" x1="5" y1="11.5" x2="20" y2="37" gradientUnits="userSpaceOnUse">
...
export const RoomsIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const ExpensesIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
// Social Login Icons matching Panel 1 of visual benchmark
export const GoogleIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24">
    <path fill="#EA4335" d="M12 5c1.6 0 3 .6 4.1 1.7l3.1-3.1C17.3 1.8 14.8 1 12 1 7.4 1 3.5 3.6 1.6 7.3l3.7 2.9C6.2 7.3 8.9 5 12 5z" />
    <path fill="#4285F4" d="M23.5 12.3c0-.8-.1-1.6-.2-2.3H12v4.6h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9c2.2-2 3.7-5 3.7-8.9z" />
    <path fill="#FBBC05" d="M5.3 14.8c-.2-.7-.4-1.5-.4-2.8s.2-2.1.4-2.8L1.6 6.3C.6 8.3 0 10.5 0 12s.6 3.7 1.6 5.7l3.7-2.9z" />
